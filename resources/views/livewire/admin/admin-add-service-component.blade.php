<div>
    ...
    <div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center text-capitalize">Formulaire d'ajout d'un nouveau service</h6>
        </div>
        <div class="card-body">
            <form class="form-horizontal" wire:submit.prevent="CreateNewService">
                ...
                <div class="form-group row d-flex justify-content-center">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control-file" type="file" name="thumbnail" id="thumbnail" wire:model="thumbnail">
                        @error('thumbnail')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
