                    ...
                    <div class="row portfolioContainer">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 profile1" style="min-height: 300px;">
                            <div class="thinborder-ontop">
                                <h3 style="margin-bottom: 2rem">Info Connexion</h3>
                                <x-jet-validation-errors class="mb-4" />
                                <form id="userloginform" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-10">
                                            @if (Route::has('password.request'))
                                                <a class="" href="{{ route('password.request') }}" title="Si vous avez oublié votre mot de passe, cliquez ici !">Mot de passe oublié ?</a>
                                            @endif
                                        </div>
                                    </div>
                                </form>
