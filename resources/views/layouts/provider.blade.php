...
<html lang="en">
    ...
    <head>
        ...
        <title>Home Service - Espace Fournisseur</title>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('provider.profile') }}">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-2">Mon Espace Fournisseur</div>
                </a>
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item {{ Request::routeIs('provider.edit_profile') ? 'active':'' }}">
                    <a class="nav-link" href="{{ route('provider.edit_profile') }}">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @endphp
                @if ($provider->image)
                    <img class="img-profile rounded-circle" src="{{asset('images/providers')}}/{{$provider->image}}">
                    @else
                    <img class="img-profile rounded-circle" src="{{asset('images/providers/default.jpg')}}" alt="{{Auth::user()->name}}">
                @endif
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{ route('provider.edit_profile') }}">
